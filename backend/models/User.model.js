...
module.exports = (sequelize) => {
    const user = sequelize.define("user",
        {
            email: { type: DataTypes.STRING, defaultValue: 0 },
            password: { type: DataTypes.STRING, defaultValue: 0 },
            role: { type: DataTypes.INTEGER, defaultValue: 0 },
            token: { type: DataTypes.STRING, defaultValue: 0 },
            regIp: { type: DataTypes.STRING, defaultValue: 0 },
            currentIp: { type: DataTypes.STRING, defaultValue: 0 },
            balance: { type: DataTypes.FLOAT(10, 2), defaultValue: 0 },
            status: { type: DataTypes.INTEGER, defaultValue: 0 },

            fullName: { type: DataTypes.STRING, defaultValue: 0 },
