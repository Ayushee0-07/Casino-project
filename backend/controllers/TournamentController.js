...
const startGame = async (req, res) => {
    ...
    for(const table of tables){
        ...
        game.setRound(new Round(game));  
        console.log("5. round created finished"); 

        await addGame(game);
        console.log("5. addGame finished");
